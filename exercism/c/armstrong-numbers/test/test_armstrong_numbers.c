...
static void
test_zero_is_an_armstrong_number(void)
{
  TEST_ASSERT_TRUE(isArmstrongNumber(0));
}

static void
test_single_digit_numbers_are_armstrong_numbers(void)
{
  TEST_ASSERT_TRUE(isArmstrongNumber(5));
}

static void
test_there_are_no_two_digit_armstrong_numbers(void)
{
  TEST_ASSERT_FALSE(isArmstrongNumber(10));
}

static void
test_three_digit_number_that_is_an_armstrong_number(void)
{
  TEST_ASSERT_TRUE(isArmstrongNumber(153));
}

static void
test_three_digit_number_that_is_not_an_armstrong_number(void)
{
  TEST_ASSERT_FALSE(isArmstrongNumber(100));
}

static void
test_four_digit_number_that_is_an_armstrong_number(void)
{
  TEST_ASSERT_TRUE(isArmstrongNumber(9474));
}

static void
test_four_digit_number_that_is_not_an_armstrong_number(void)
{
  TEST_ASSERT_FALSE(isArmstrongNumber(9475));
}

static void
test_seven_digit_number_that_is_an_armstrong_number(void)
{
  TEST_ASSERT_TRUE(isArmstrongNumber(9926315));
}

static void
test_seven_digit_number_that_is_not_an_armstrong_number(void)
{
